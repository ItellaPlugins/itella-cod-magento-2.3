define(
    ...
    function (Component, quote, priceUtils, totals, ko, getTotalsAction, url, $, t) {
        ...
        return Component.extend({
            defaults: {
                template: 'Itella_Cod/checkout/cod-fee',
                itellaTitle: $.mage.__('Cash On Delivery Fee'),
        ...
                    var linkUrl = url.build('itellacod/checkout/applyPaymentMethod');
                    jQuery.ajax(linkUrl, {
        ...
                    });
            ...
            getFeeValue: function(totals) {
                ...
                return totals.total_segments.reduce(function (cashOnDeliveryTotalValue, currentTotal) {
                    return currentTotal.code === 'itella_cod_fee' ? currentTotal.value : cashOnDeliveryTotalValue
                }, 0.0);
            },
